            ...
            if typeChk="Y" and sizeChk="Y" then
                ...
                if Err.Number = 0 then
                    ...
                    saveSql = "insert into "&tableName&" " &_
                              ...
                              " values (N'"&writer&"', N'"&subject&"',N'"&subjectKr&"', N'"&content&"', '"&saveFileName&"', '"&fileSize&"', '"&imgWidth&"', '"&imgHeight&"', '"&thumbNailFile&"','"&thumbViewFile&"', getDate(),'"&userIp&"', '"&cate&"')"
