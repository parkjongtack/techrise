...
Dim saveFileDir : saveFileDir = Server.MapPath(".") &"gallery\"  '' 이미지지가 저장될 상위 경로
...
Dim imageLocation : imageLocation = "/gallery/photos/"  ' 주 이미지 경로
Dim thumbLocation : thumbLocation = "/gallery/photos/sm/"  ' 썸네일 이미지 경로
